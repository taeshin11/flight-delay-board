...
export function AdsterraDisplay() {
  ...
  useEffect(() => {
    ...
    opt.textContent = `atOptions = { 'key': '2569323a0742bef6bf3f367cd8895b8d', 'format': 'iframe', 'height': 90, 'width': 728, 'params': {} };`;
    ref.current.appendChild(opt);
    const invoke = document.createElement('script');
    invoke.src = 'https://www.highperformanceformat.com/2569323a0742bef6bf3f367cd8895b8d/invoke.js';
